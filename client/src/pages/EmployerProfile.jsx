...
const EmployerProfile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const token = localStorage.getItem('token');
      await updateEmployerProfile(formData, token);
      ...
      <div className="p-12 max-w-4xl mx-auto w-full">
        ...
        <div className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-sm text-white/80 ml-1">Company Name</label>
              <input 
                type="text" 
                name="company_name"
            ...
            <div className="space-y-2">
              <label className="text-sm text-white/80 ml-1">Company Address</label>
              <input 
                type="text" 
            ...
            <div className="space-y-2 md:col-span-2">
              <label className="text-sm text-white/80 ml-1">About (Company Description)</label>
              <textarea 
                name="about_company"
                ...
                placeholder="We are a leading SaaS company building..."
              />
            </div>
